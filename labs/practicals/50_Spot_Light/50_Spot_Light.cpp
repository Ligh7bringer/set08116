...
bool load_content() {
  ...
  meshes["box"].get_material().set_shininess(25.0);
  ...
  meshes["tetra"].get_material().set_shininess(25.0);
  ...
  meshes["pyramid"].get_material().set_shininess(25.0);
  ...
  meshes["disk"].get_material().set_shininess(25.0);
  ...
  meshes["cylinder"].get_material().set_shininess(25.0);
  ...
  meshes["sphere"].get_material().set_shininess(25.0);
  ...
  meshes["torus"].get_material().set_shininess(25.0);
  ...
  // Set lighting values
  // Position (-25, 10, -10)
  light.set_position(vec3(-25.0, 10.0, -10.0));
  // Light colour white
  light.set_light_colour(vec4(1.0f,1.0f,1.0f,1.0f));
  // Light direction to forward and down (normalized)
  light.set_direction(vec3(0.0, -1.0, -1.0));
  // Set range to 20
